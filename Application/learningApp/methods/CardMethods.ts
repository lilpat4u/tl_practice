...
import { createCard, changeCard, deleteCard } from "../types/Card";
import { addCardToCardSet, deleteCardSet, updateNameCardSet, CardSet } from "../types/CardSet";
...
function changeCardFrontsideInCardSet(app: Application, cardSetId: string, cardId: string, newFrontside: string): Application {
    const updatedCardSets = app.cardSets.map(cardSet => {
        if (cardSet.id !== cardSetId) {
            return cardSet;
        }
...
function changeCardBacksideInCardSet(app: Application, cardSetId: string, cardId: string, newBackside: string): Application {
    const updatedCardSets = app.cardSets.map(cardSet => {
        if (cardSet.id !== cardSetId) {
            return cardSet;
        }
...
export {
    addNewCardToCardSet,
    deleteCardFromCardSet,
    changeCardFrontsideInCardSet,
    changeCardBacksideInCardSet
};